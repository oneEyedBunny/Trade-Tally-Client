import {ADD_NEW_TRADE_SUCCESS, DELETE_TRADE_SUCCESS, EDIT_TRADE_SUCCESS, GET_TRADES_SUCCESS} from "../actions/trades";
...
export function tradesReducer(state = initialState, action) {
  if (action.type === ADD_NEW_TRADE_SUCCESS) {
